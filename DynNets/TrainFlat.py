...
train_data   = CustomMawiDataset(author=author, year=year, month='01', as_matrix=False)
train_loader = DataLoader(train_data, batch_size=batch_size, shuffle=True)


model = DynNetFlat(input_sample=train_data).to(device)
